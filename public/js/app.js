$(document).ready(function(){
    ...
    function validate_dateofbirth(){
        if(!($("#input-date-of-birth").val())){
            $("#input-date-of-birth").css("border-color","red");
            $("#date-of-birth").css("color","red");
            dateofbirth=false;
        }else{
            $("#input-date-of-birth").css("border-color","green");
            $("#date-of-birth").css("color","green");
            dateofbirth=true;
        }
    }
